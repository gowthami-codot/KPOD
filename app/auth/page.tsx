      ...
      <div className="w-full md:px-20">
        <div className="md:p-10 p-5 rounded-2xl bg-[#ffffff15] flex flex-col md:flex-row items-start justify-between md:gap-10">
          ...
          <div className="w-full md:w-[60%] flex flex-col justify-between h-full">
            <div className="text-lg md:text-xl pb-3 md:pb-6 mt-5">What do you do? Choose one or more</div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
              <div className="bg-white text-black p-5 rounded-lg text-center
              cursor-pointer">Cloud Engineer</div>
              <div className="bg-white text-black p-5 rounded-lg text-center
              cursor-pointer">Devops</div>
              <div className="bg-white text-black p-5 rounded-lg text-center
              cursor-pointer">Data Scientist</div>
              <div className="bg-white text-black p-5 rounded-lg text-center
              cursor-pointer">Product Management</div>
              <div className="bg-white text-black p-5 rounded-lg text-center
              cursor-pointer">SRE</div>
              <div className="bg-white text-black p-5 rounded-lg text-center
              cursor-pointer">Others</div>
            </div>
            <div className="flex text-black mt-10 bg-white py-3 px-10 w-fit mx-auto rounded-full cursor-pointer
