  ...
  return (
    <div className="flex flex-col min-h-screen   px-5 relative">
      <div className="w-full h-full bg-[#0F1B2B]  rounded-[16px]">
        ...
        <div className="w-[97%] flex justify-between border mx-3 border-[#80FFF7] p-5 rounded-xl z-0" style={{ maxHeight: '70vh', overflowY: 'auto' }}>
...
const Popup = ({onClose}) => {
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center bg-[#3d3939] bg-opacity-50">
      <div ref={popupRef} className="absolute p-10   rounded-[20px] shadow-lg bg-[#162231] w-1/3">
