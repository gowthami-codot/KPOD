    ...
    <div className="flex items-center justify-center mt-40 md:mt-56 w-full">
      ...
      >
        ...
        <div className="text-gray-400 text-center">
          AI Cloud - Managed AI cloud services for full lifecycle of Generative
          AI needs from training to inferencing supported by platforms
        </div>
        <div
        ...
        <VMConfigModal isOpen={showModal} />
      )}
    </div>
  );
};
