      ...
      <div className="py-10 md:py-20 px-5 md:px-40">
        <div className="flex flex-col md:flex-row gap-3 md:gap-6 items-center">
          <div className="w-full md:w-[70%] flex flex-col gap-3 md:gap-6">
            <div className="border border-gray-100 p-4 md:p-10 rounded-2xl">
            ...
            <div className="flex flex-col md:flex-row gap-3 md:gap-6">
              <div className="w-full border border-gray-100 p-4 md:p-10 rounded-2xl">
              ...
              <div className="w-full border border-gray-100 p-4 md:p-10 rounded-2xl relative">
          ...
          <div className="md:w-[30%] flex flex-col w-full gap-3 md:gap-6">
            <div className="w-full border border-gray-100 p-4 md:p-10 rounded-2xl">
              <div className="text-lg font-bold">Scalable Resources</div>
              <div className="text-xs my-3 md:my-6">
                Enable users to scale their GPU resources up or down instantly
                depending on their project needs, which provides flexibility and
                cost-effectiveness.
              </div>
            </div>
            <div className="w-full border border-gray-100 p-4 md:p-10 rounded-2xl">
